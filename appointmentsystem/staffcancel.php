...
if(isset($_POST['delete'])){
	$delete = mysqli_query($conn, "DELETE FROM active_appointments WHERE appoi_ID='{$_POST['pn']}'");
...
<tr>
	<td class="display-4">Are you sure you want to <b>Cancel?<b> </td>
    <td><input type="submit" name="delete" value="Yes"  class="btn btn-danger" onmousedown="back.play()"></td>
	<br/>
	<br/>
	<td><input class="btn btn-warning" type="button" value="No" onmousedown="moveback.play()" onclick="window.location='viewCustomerAppointments.php'"></td>
</tr>
</table>
	</b>
	</div>
