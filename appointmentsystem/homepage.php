...
<body>
  ...
  <div class="w3-bar w3-white w3-card" id="myNavbar">
    ...
    <div class="w3-right w3-hide-small">
	  ...
	  <a href="login.php" onmousedown="bleep.play()">LOGIN</a>
	  <a href="register.php" onmousedown="bleep.play()">REGISTER</a>
      <a href="#about"  class="w3-bar-item w3-button">ABOUT</a>
      <a href="#work"   class="w3-bar-item w3-button"><i class="fa fa-th"></i> CHECKLIST</a>
      <a href="#pricing"  class="w3-bar-item w3-button"><i class="fa fa-usd"></i> JOB VACANCIES</a>
