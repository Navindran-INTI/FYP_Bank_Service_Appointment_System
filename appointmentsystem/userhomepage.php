  ...
  <div class="w3-bar w3-white w3-card" id="myNavbar">
    ...
    <div class="w3-right w3-hide-small">
	 <p>Hi, <?php echo $_SESSION['username']." ".$msg ;?></p>
      ...
      <a href="#about"  class="w3-bar-item w3-button">MyInfo</a>
...
<div class="w3-center jobdiv" style="padding:128px 16px" id="work">
...
<div class="jobsegment"
       ...
       <?php
		...
		$query= "SELECT name, description FROM available_services";
...
while($row = mysqli_fetch_array($result)){
    ...
    <thead class="thead-dark"><tr style="background-color:#ADD8E6">';
	
        echo '<td >'.$row[0].'</td>' ;
		echo "<td>";
			?>
				<a href="serviceDetail.php?pn=<?php echo $row[0];?>">
...
echo '</table>';
	...
	?>
<div class="w3-center jobdiv" style="padding:12px 16px" id="about">
